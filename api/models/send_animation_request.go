...
// SendAnimationRequest represents `sendAnimation` request body.
type SendAnimationRequest struct {
	...
	Animation form.Part `form:"animation"`
	...
	// Optional. Animation caption (may also be used when resending documents by file_id),
